...
const styles = StyleSheet.create({
  ...
  filterText: { fontSize: 14, fontWeight: '700', flexShrink: 0 },
  filterTextActive: { fontSize: 14, fontWeight: '700', color: '#fff', flexShrink: 0 },
  ...
  badge: { fontSize: 15, fontWeight: '800', opacity: 0.85, flexShrink: 0 },
