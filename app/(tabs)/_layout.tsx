...
export default function TabLayout() {
  return (
    <Stack>
      ...
      <Stack.Screen name="admin-admin" options={{ title: '관리자 설정' }} />
      <Stack.Screen name="adminpopup" options={{ title: '팝업창 설정' }} />
      <Stack.Screen name="count" options={{ title: '현황 집계' }} />
      <Stack.Screen name="count-admin" options={{ title: '현황 집계' }} />
      ...
      <Stack.Screen name="list" options={{ title: '공지사항' }} />
      <Stack.Screen name="write" options={{ title: '공지사항 작성' }} />
      <Stack.Screen name="idpostcard/[id]" options={{ title: '공지사항 상세' }} />
    </Stack>
  );
}
